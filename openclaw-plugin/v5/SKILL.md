...
metadata: { "openclaw": { "emoji": "🛡️", "primaryEnv": "CLAWGUARD_DAEMON_PORT", "install": [{ "id": "curl-install", "kind": "download", "url": "https://www.clawguard.site/download/install.sh", "label": "Install ClawGuard (curl)" }], "os": ["darwin", "linux"] } }
---
